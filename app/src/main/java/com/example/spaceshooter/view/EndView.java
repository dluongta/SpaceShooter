...
public class EndView extends BaseView {
    ...
    private String startGame = "Restart";    
    ...
    public void drawSelf() {
        try {
            ...
            float textlong = paint.measureText("Total Point:" + String.valueOf(score));
            canvas.drawText("Total Point:" + String.valueOf(score), screen_width / 2 - textlong / 2, screen_height / 2 - 100, paint);
        } catch (Exception err) {
            err.printStackTrace();
        } finally {
            if (canvas != null)
